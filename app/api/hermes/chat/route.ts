...
type RequestBody = {
  ...
  context: {
    ...
    obsHost: string;
    obsPort: number;
    x18Connected: boolean;
    x18Ip: string;
    x18Port: number;
    x18ChannelMap: Array<{ channel: number; name: string; color?: string }>;
    ...
    audioPresets: string[];
    mixProfiles?: Array<{ key: string; label: string; channelCount: number; updatedAt?: string }>;
...
const instruction = [
  ...
  'Acoes permitidas: {"type":"navigateTab","tab":"buttons|audio|media|hermes|config"}, {"type":"scene","sceneName":"..."}, {"type":"previewScene","sceneName":"..."}, {"type":"createScene","sceneName":"..."}, {"type":"deleteScene","sceneName":"..."}, {"type":"volume","inputName":"...","deltaPercent":8}, {"type":"mute","inputName":"...","state":true}, {"type":"stream","action":"start|stop"}, {"type":"record","action":"start|stop"}, {"type":"studioMode","enabled":true}, {"type":"triggerTransition"}, {"type":"connectX18"}, {"type":"configureX18","ip":"172.18.182.1","port":10024}, {"type":"saveMixProfile","profile":"igreja|live"}, {"type":"applyMixProfile","profile":"igreja|live"}, {"type":"x18Fader","channel":1,"channelName":"Mic Pastor","levelPercent":70}, {"type":"x18Mute","channel":1,"channelName":"Mic Pastor","muted":true}, {"type":"x18Send","channel":1,"channelName":"Mic Pastor","bus":1,"levelPercent":65}, {"type":"x18Gain","channel":1,"gainPercent":50}, {"type":"x18Phantom","channel":1,"enabled":true}, {"type":"x18Eq","channel":1,"channelName":"Mic Pastor","band":1,"gainPercent":55,"frequencyPercent":40,"qPercent":50,"enabled":true}, {"type":"x18Gate","channel":1,"channelName":"Mic Pastor","enabled":true,"thresholdPercent":45,"rangePercent":60}, {"type":"x18Compressor","channel":1,"channelName":"Mic Pastor","enabled":true,"thresholdPercent":50,"ratioPercent":40,"makeupPercent":35}, {"type":"x18MainMute","muted":false}, {"type":"x18RenameChannel","channel":1,"name":"Mic Pastor"}, {"type":"x18ApplyPreset","presetName":"pregacao|louvor|seguranca|retorno-pastor|live"}, {"type":"x18Osc","address":"/ch/01/gate/on","argType":"i","value":1}, {"type":"connectObs"}, {"type":"disconnectObs"}, {"type":"configureObs","host":"...","port":4455,"password":"..."}, {"type":"setSceneMap","role":"aguardando|louvor|oferta|biblia|pregacao|encerramento","sceneName":"..."}, {"type":"speakResponses","enabled":true}, {"type":"createButton","name":"...","buttonType":"scene|audio|media|macro","sceneName":"...","inputName":"...","audioMode":"toggleMute|setVolume","volumePercent":70,"macroId":1,"sourceName":"...","mediaMode":"play|stop|replace|show|hide","mediaId":1,"settingKey":"local_file"}, {"type":"runButton","buttonName":"..."}, {"type":"deleteButton","buttonName":"..."}, {"type":"createMacro","name":"...","actions":[...]}, {"type":"runMacro","macroName":"..."}, {"type":"deleteMacro","macroName":"..."}, {"type":"createAudioPreset","name":"...","description":"...","color":"#38bdf8","fallbackVolumePercent":20,"fallbackMuted":false,"applyToUnmatched":true,"rules":[...]}, {"type":"applyAudioPreset","presetName":"..."}, {"type":"deleteAudioPreset","presetName":"..."}, {"type":"createRecommendedPreset","presetName":"Voz Limpa|Voz + Fundo|Banda / Louvor|Momento de Palavra|Seguranca Anti-Estouro"}, {"type":"createInput","sceneName":"...","inputName":"...","inputKind":"image_source|ffmpeg_source|browser_source|wasapi_input_capture|wasapi_output_capture","inputSettings":{},"sceneItemEnabled":true}, {"type":"deleteInput","inputName":"..."}, {"type":"media","sourceName":"...","mediaName":"...","mode":"play|stop|replace|show|hide","mediaId":1,"sceneName":"...","sceneItemId":10,"sceneItemName":"...","settingKey":"local_file"}, {"type":"autoMode","enabled":true}, {"type":"startCulto"}, {"type":"status"}',
  "Voce pode operar boa parte do OBS pelo app: conexao, stream, gravacao, modo estudio, preview, transicao, criacao e exclusao de cenas, criacao e exclusao de fontes, audio, respostas por voz, criacao, execucao e exclusao de botoes, macros e presets, inclusive botoes de midia e acoes diretas em fontes de midia. Tambem pode operar a X18/XR18 por OSC: conectar, ajustar fader, mute, sends, gain de headamp, phantom, EQ, gate, compressor, mute do LR, renomear canal, aplicar presets basicos de mix e enviar comandos OSC diretos quando necessario.",
